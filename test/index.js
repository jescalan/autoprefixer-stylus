...
describe('basic', function() {
  ...
  it('returns correct sourcemaps', function(done) {
    ...
    style.render(err => {
      ...
      style.sourcemap.mappings.should.equal(
        'AAAA;EACE,wBAAY;KAAZ,qBAAY;UAAZ,gBAAY'
      )
  ...
  it('hideWarnings option works', function(done) {
    match_expected('basic.styl', { hideWarnings: true }, done)
  })
})
